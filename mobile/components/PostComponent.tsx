    ...
    <View className='border-b border-gray-100 p-4 bg-white'>
      <View className='flex-row'>
        ...
        <View className='flex-1'>
          <TextInput className='text-gray-900 text-lg' placeholder='What&apos;s good?'
      ...
      {selectedImage && (
        <View className='mt-3 ml-15'>
          <View className='relative'>
            ...
            <TouchableOpacity className='absolute top-2 right-2 size-8 bg-black bg-opacity-60 rounded-full items-center justify-center' onPress={removeImage}>
      ...
      <View className='flex-row items-center'>
        ...
        <TouchableOpacity className={`px-6 py-2 rounded-full ${content.trim() || selectedImage ? "bg-blue-500" :"bg-gray-300"}`} onPress={createPost} 
